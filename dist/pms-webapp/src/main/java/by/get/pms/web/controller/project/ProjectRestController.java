...
public class ProjectRestController {
    ...
    //	@PreAuthorize("hasRole('ROLE_ADMIN_USER')")
    @RequestMapping(value = WebConstants.UPDATE_PROJECT_URL, method = RequestMethod.PUT)
    private Response updateProject(ProjectDTO projectParams, ResponseBuilder builder) {
        try {
