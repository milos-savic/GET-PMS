...
class ProjectServiceImpl implements ProjectService {
	...
	public List<ProjectDTO> getAll() {
		...
		return projects.parallelStream().map(Data2DtoTransformers.PROJECT_DATA_2_PROJECT_DTO_TRANSFORMER::apply)
	...
	public ProjectDTO createProject(ProjectDTO projectParams) {
		ProjectData projectData = projectDAO
				.create(Dto2DataTransformers.PROJECT_DTO_2_PROJECT_DATA_TRANSFORMER.apply(projectParams));
